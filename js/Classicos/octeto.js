...
function salvarProgresso() {
  ...
  localStorage.setItem("termo_octeto", JSON.stringify(save));
}

export function iniciarModoOcteto(bancoDePalavras, listaSolucoes) {
  ...
  let save = null;
  try {
    save = JSON.parse(localStorage.getItem("termo_octeto"));
  } catch {
...
export function receberTeclaOcteto(tecla) {
